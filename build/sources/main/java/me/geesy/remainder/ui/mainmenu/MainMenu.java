...
public class MainMenu extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new MenuButton(1, (int) (s.getScaledWidth() / 2 - 240), (int) (s.getScaledHeight() / 2 - 10), 75, 20, "Multiplayer"));
        this.buttonList.add(new MenuButton(2, (int) (s.getScaledWidth() / 2 - 330), (int) (s.getScaledHeight() / 2 - 5), 75, 20, "Singleplayer"));
    ...
    public void drawScreen(int p_drawScreen_1_, int p_drawScreen_2_, float p_drawScreen_3_) {
        ...
        FontUtil.normal.drawString("Toggle Display", s.getScaledWidth() - 99, s.getScaledHeight() / 50 + 2, 0xFFFFFF);
        ...
        //outline for the "toggle display"
        RenderUtil.drawRoundedOutline(s.getScaledWidth() - 100, s.getScaledHeight() / 50 - 7, s.getScaledWidth() - 30, s.getScaledHeight() / 50 + 17, 5, 2, -1);
