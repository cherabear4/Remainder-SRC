package me.geesy.remainder.ui.loginfield.microsoft;

import me.geesy.remainder.util.SessionChanger;
...
public class GuiLoginMicrosoft extends GuiScreen {
    ...
    public void drawScreen(final int x2, final int y2, final float z2) {
        ...
        FontUtil.normal.drawString("Email & Password", (int)(this.width / 2), (int)(sr.getScaledHeight() / 2 - 65), -1);
